# COMP1531 Major Project Java version

**✨ Teamwork makes the UNSW Seams work 🌈**

## Contents

- [COMP1531 Major Project Java version](#comp1531-major-project-java-version)
  - [Contents](#contents)
  - [1. Aims:](#1-aims)
  ...
  - [6. Interface specifications](#6-interface-specifications)
    ...
    - [6.15. profile_img_url & image uploads](#615-profile_img_url--image-uploads)
...
Develop a series of questions to ask these target users to understand what _problems_ they might have with teamwork-driven communication tools that are currently unsolved by Seams. Give these questions to your target users and record their answers.
...
<table>
  ...
  <tr>
    <td><code>user/stats/v1</code><br /><br />Fetches the required statistics about this user's use of UNSW Seams.</td>
    <td style="font-weight: bold; color: green;">GET</td>
